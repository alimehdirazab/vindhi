...
class HomeLoanForm extends StatefulWidget {
  ...
  static const routeName = 'homeloanform';
...
class _HomeLoanFormState extends State<HomeLoanForm> {
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        await MainRepository(Api()).requestHomeLoan(
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: const Text(
                  'Your Home loan request was submitted successfully.'),
              actions: <Widget>[
                TextButton(
                  child: const Text('OK'),
                  onPressed: () {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Home Loan Form',
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              children: [
                Image.asset('assets/home_loan.jpg', height: 200),
                Padding(
